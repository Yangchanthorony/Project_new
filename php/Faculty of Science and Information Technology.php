    ...
    <div class="container">
        <nav class="navbarr">
           ...
           <a href="student_office.php"> <button style="margin-left: 5px;" class="nav-button">Student Service Office</button></a>
            <a href="front_office.php"><button style="margin-left: 5px;" class="nav-button ">Front Office</button></a>
        </nav>

        <div class="faculties">
        <a href="Faculty of Educational Sciences,.php"><button  class="nav-button ">Faculty of Educational Sciences</button></a>
        <a href="Faculty of Science and Information Technology.php"><button style="margin-left: 5px;" class="nav-button active ">Faculty of Science and Information Technology</button></a>
        ...
        <div class="contact-section">
            <div class="contact-info">
                ...
                <p>For more information, please contact the following link:</p>

...
<div class="container">
    ...
    <h5  style="color: red;">DOCTORAL DEGREE</h5>
    <p class="aa" >       Doctoral (PhD) is a degree that Phnom Penh Internaitonal Unversity (PPIU) provides to all students who had aleady passed their Master's degree. They are eligible for registering their study at PPIU, by just fulfil the following conditions:  </p>
    ...
    <p style="margin-left: 50px;">        - Enroll today!</p>

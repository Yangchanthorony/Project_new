...
<div class="header-pattern">
    <div class="header" id="career-header">Career Opportunities</div>
</div>

<!-- Content Section -->
<div class="container">
    <section class="text-section">
        <p style="margin-top: 20px;" class="section-text" id="career-intro">
            It is the mission of the human resources department to develop, implement, and support processes that add value to PPIU and its employees, 
            leading to improved employee welfare, empowerment, growth, and retention, while remaining committed to PPIU key business drivers, 
            its management, and prosperity for its students, employees, and community partners.
        </p>
    </section>

    <section class="text-section">
        <h4 class="section-title" id="about-ppiu-title">About PPIU</h4>
        <p class="section-text" id="about-ppiu-text1">
        ...
        <p class="section-text" id="about-ppiu-text2">
    ...
    <section class="text-section">
        <h4 class="section-title" id="working-ppiu-title">Working at PPIU</h4>
        <p class="section-text" id="working-ppiu-text1">
        ...
        <p class="section-text" id="working-ppiu-text2">
        ...
        <p class="section-text" id="working-ppiu-text3">
